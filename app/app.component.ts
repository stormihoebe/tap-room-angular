...
export class AppComponent{
  masterKegList:Keg[]=[
    new Keg("The Vaporizer", "Double Mountain Brewery", "Ale", "Hazy-gold with a sweet, grainy start and a dry, lemony finish, this dry-hopped summer sipper is brewed with pilsner malt and Challenger hops grown in Washington’s Yakima Valley.", 8, 6, 124, "https://s3-us-west-2.amazonaws.com/homebrewassoc/wp-content/uploads/2015/02/berliner-trappist-recipe-400x400.jpg"),
    ...
    new Keg("The Salty Teaser", "Double Dragon Brewery", "Pilsner", "Beer ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco", 8, 6, 124, "http://www.visitflorida.com/content/visitflorida/en-us/eat-drink/florida-craft-beer-breweries/_jcr_content/editorial_parsys/vf_col_ctrl/column_parsys1/vf_image.img.400.400.jpg"),
    new Keg("Crazy Pumpkin", "Nose of the Dog Brewing", "Lager", "Beer ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.", 7, 7, 124,"http://img.wennermedia.com/square-400/e7bp06-0d72f11d-b44f-4117-ad8e-95932c4d25a9.jpg"
    ),
    new Keg("Hot Shot", "Big Foot", "Stout", "Beer ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco", 6, 7.7, 124, "http://www.studiobrew.beer/wp-content/uploads/studiobrew-darkrider-sm.jpg")
  ];
  selectedKeg = null;
  finishedEditing() {
